...
return array(
    'WEIXIN_API_URL'    =>  array(
        ...
        'create_department' => 'https://qyapi.weixin.qq.com/cgi-bin/department/create',
        'update_department' => 'https://qyapi.weixin.qq.com/cgi-bin/department/update',
        'delete_department' => 'https://qyapi.weixin.qq.com/cgi-bin/department/delete',
        'get_user'  =>  'https://qyapi.weixin.qq.com/cgi-bin/user/get', //获取成员
        'get_user_simpleList'   =>  'https://qyapi.weixin.qq.com/cgi-bin/user/simplelist',  //获取部门成员
        'get_user_list'   =>  'https://qyapi.weixin.qq.com/cgi-bin/user/list',  //获取部门成员(详情)
        'invite_send'   =>  'https://qyapi.weixin.qq.com/cgi-bin/invite/send',  //邀请成员关注
        'create_user'   =>  'https://qyapi.weixin.qq.com/cgi-bin/user/create',  //创建成员
        'update_user'   =>  'https://qyapi.weixin.qq.com/cgi-bin/user/update',  //更新成员
